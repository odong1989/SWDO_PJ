...
public interface MemberMapper {
	...
	public Member memberSelectOne3 (Member member);	//비번,ID 수정위해 2개 이상의 값을 갖고 오기 위해 변경
	//public Member memberSelectOne (String member_id);를 대체 할필요성 논의 할것.
	
	//3.업데이트
	//3.1 회원정보 수정
	public void   memberUpdate(Member member);
	public void   memberUpdatePW(String changePW);//사용자가 비번잊었을 경우 랜덤변경.(이후 코드 통해 메일로 전송)
